...
export const en: LocaleData = {
  ...
  profile: {
    ...
    about: {
      ...
      intro:
        "Software Developer with 4+ years of experience building enterprise web applications, with strong expertise in React.js, Next.js, TypeScript, and UI Design Systems. Proven track record in optimizing Core Web Vitals, developing accessible UIs, component-driven development with Storybook, and designing effective Information Architecture. Experienced in developing scalable UI architectures, state management, API integration, automated testing, and backend services using ASP.NET Core and PHP Laravel. Worked across banking, education, healthcare, financial information, and business management systems, collaborating with cross-functional teams and clients to deliver production-ready solutions.",
